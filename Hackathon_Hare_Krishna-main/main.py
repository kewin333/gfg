...
def upload_video():
    ...
    if request.method == 'POST':
        ...
        video.save(r'C:\Users\SAHAYA KEWINSTON\OneDrive\Desktop\Hackathon_Hare_Krishna-main\Videos\test1.mp4')
        
        msg="Video uploaded"
        output="Help"
        model_path=r"C:\Users\SAHAYA KEWINSTON\OneDrive\Desktop\Hackathon_Hare_Krishna-main\model.h5"
        model = load_model(model_path)
        
        output=predict_video("test",r'C:\Users\SAHAYA KEWINSTON\OneDrive\Desktop\Hackathon_Hare_Krishna-main\Videos\test1.mp4',model)
...
def predict_video(video_name,video_path,model):
  ...
  df_predict,track=storeInDataFrame(r'C:\Users\SAHAYA KEWINSTON\OneDrive\Desktop\Hackathon_Hare_Krishna-main\Videos',video_name,df_predict,track,video_path)
  df_predict.info()
  ...
  y_pred_probs = model.predict(np.expand_dims(x_predict,axis=0))
